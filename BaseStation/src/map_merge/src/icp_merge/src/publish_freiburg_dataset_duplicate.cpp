...
int main(int argc, char **argv){
    ...
    ros::init(argc, argv, "freiburg_publisher_2"); 
    ros::NodeHandle nh; 
    ros::Publisher pub = nh.advertise<sensor_msgs::PointCloud2>("scan_2",1, true);
    ...
    std::ifstream ifile;
    ifile.open ("freiburg_dataset/scan_005_points.dat");
