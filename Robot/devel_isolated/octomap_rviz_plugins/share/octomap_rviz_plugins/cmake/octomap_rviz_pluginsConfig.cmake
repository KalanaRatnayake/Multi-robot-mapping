...
if(NOT "/home/kalana/Xavier/Robot/src/octomap/octomap_rviz/include " STREQUAL " ")
  set(octomap_rviz_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/kalana/Xavier/Robot/src/octomap/octomap_rviz/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'octomap_rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kalana/Xavier/Robot/src/octomap/octomap_rviz/${idir}'.  ${_report}")
    endif()
