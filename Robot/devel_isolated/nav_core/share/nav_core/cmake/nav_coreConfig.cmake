...
if(NOT "/home/kalana/Xavier/Robot/src/Navigation/navigation-kinetic-devel/nav_core/include " STREQUAL " ")
  set(nav_core_INCLUDE_DIRS "")
  set(_include_dirs "/home/kalana/Xavier/Robot/src/Navigation/navigation-kinetic-devel/nav_core/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nav_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kalana/Xavier/Robot/src/Navigation/navigation-kinetic-devel/nav_core/${idir}'.  ${_report}")
    endif()
