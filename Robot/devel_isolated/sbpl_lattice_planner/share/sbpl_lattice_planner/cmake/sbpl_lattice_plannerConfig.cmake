...
if("TRUE" STREQUAL "TRUE")
  ...
  set(sbpl_lattice_planner_INSTALL_PREFIX /home/kalana/Xavier/Robot/install_isolated)
...
if(NOT "/home/kalana/Xavier/Robot/devel_isolated/sbpl_lattice_planner/include;/home/kalana/Xavier/Robot/src/Navigation_setup/navigation_experimental-kinetic-devel/sbpl_lattice_planner/include " STREQUAL " ")
  set(sbpl_lattice_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/kalana/Xavier/Robot/devel_isolated/sbpl_lattice_planner/include;/home/kalana/Xavier/Robot/src/Navigation_setup/navigation_experimental-kinetic-devel/sbpl_lattice_planner/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sbpl_lattice_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kalana/Xavier/Robot/src/Navigation_setup/navigation_experimental-kinetic-devel/sbpl_lattice_planner/${idir}'.  ${_report}")
    endif()
    _list_append_unique(sbpl_lattice_planner_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "sbpl_lattice_planner")
