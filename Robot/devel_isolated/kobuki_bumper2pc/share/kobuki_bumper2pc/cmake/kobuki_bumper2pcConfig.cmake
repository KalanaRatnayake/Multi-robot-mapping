...
if(NOT "/home/kalana/Xavier/Robot/src/kobuki/kobuki_bumper2pc/include " STREQUAL " ")
  set(kobuki_bumper2pc_INCLUDE_DIRS "")
  set(_include_dirs "/home/kalana/Xavier/Robot/src/kobuki/kobuki_bumper2pc/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_bumper2pc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kalana/Xavier/Robot/src/kobuki/kobuki_bumper2pc/${idir}'.  ${_report}")
    endif()
