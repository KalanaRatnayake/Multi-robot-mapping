...
if("TRUE" STREQUAL "TRUE")
  set(multimaster_msgs_fkie_SOURCE_PREFIX /home/kalana/Xavier/Robot/src/multimaster_fkie/src/multimaster_msgs_fkie)
  set(multimaster_msgs_fkie_DEVEL_PREFIX /home/kalana/Xavier/Robot/devel_isolated/multimaster_msgs_fkie)
  ...
  set(multimaster_msgs_fkie_INSTALL_PREFIX /home/kalana/Xavier/Robot/install_isolated)
...
if(NOT "/home/kalana/Xavier/Robot/devel_isolated/multimaster_msgs_fkie/include " STREQUAL " ")
  set(multimaster_msgs_fkie_INCLUDE_DIRS "")
  set(_include_dirs "/home/kalana/Xavier/Robot/devel_isolated/multimaster_msgs_fkie/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multimaster_msgs_fkie' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kalana/Xavier/Robot/src/multimaster_fkie/src/multimaster_msgs_fkie/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT multimaster_msgs_fkie_NUM_DUMMY_TARGETS)
      set(multimaster_msgs_fkie_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::multimaster_msgs_fkie::wrapped-linker-option${multimaster_msgs_fkie_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR multimaster_msgs_fkie_NUM_DUMMY_TARGETS "${multimaster_msgs_fkie_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::multimaster_msgs_fkie::wrapped-linker-option${multimaster_msgs_fkie_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND multimaster_msgs_fkie_LIBRARIES "${interface_target_name}")
