...
if("TRUE" STREQUAL "TRUE")
  ...
  set(kobuki_controller_tutorial_INSTALL_PREFIX /home/kalana/Xavier/Robot/install_isolated)
...
if(NOT "/home/kalana/Xavier/Robot/src/kobuki_setup/kobuki_controller_tutorial/include " STREQUAL " ")
  set(kobuki_controller_tutorial_INCLUDE_DIRS "")
  set(_include_dirs "/home/kalana/Xavier/Robot/src/kobuki_setup/kobuki_controller_tutorial/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_controller_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kalana/Xavier/Robot/src/kobuki_setup/kobuki_controller_tutorial/${idir}'.  ${_report}")
    endif()
