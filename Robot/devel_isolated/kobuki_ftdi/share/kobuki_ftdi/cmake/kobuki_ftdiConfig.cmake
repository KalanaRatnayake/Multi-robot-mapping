...
if("TRUE" STREQUAL "TRUE")
  set(kobuki_ftdi_SOURCE_PREFIX /home/kalana/Xavier/Robot/src/kobuki/kobuki_ftdi)
...
if(NOT "/home/kalana/Xavier/Robot/src/kobuki/kobuki_ftdi/include " STREQUAL " ")
  set(kobuki_ftdi_INCLUDE_DIRS "")
  set(_include_dirs "/home/kalana/Xavier/Robot/src/kobuki/kobuki_ftdi/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_ftdi' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kalana/Xavier/Robot/src/kobuki/kobuki_ftdi/${idir}'.  ${_report}")
    endif()
